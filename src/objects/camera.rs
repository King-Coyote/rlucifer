...
impl Camera {
    ...
    pub fn pixel_to_img(&self, x: usize, y: usize) -> Vector3 {
        let alpha = ((x as i32 / self.width) as f32) - 0.5; // alpha and beta are normalisation factors. Here I have assumed FOV is 45 degrees and that the screen varies from 0 to 1.
        let beta = ((y as i32/ self.height) as f32) - 0.5;
